...
const TeacherProExperience = ({ content = component.content, style = component.style }) => (
  <motion.section
      ...
      <div className="space-y-8 lg:space-y-12">
        {content.items.map((experience, idx) => (
          <motion.div
            ...
            className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl lg:rounded-3xl shadow-2xl p-6 lg:p-8 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300"
          >
...
export default TeacherProExperience; 