...
const TeacherPremiumAchievements = ({ content = component.content, style = component.style }) => (
  <motion.section
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        {content.items.map((achievement, idx) => (
          <motion.div
            ...
            className="bg-white rounded-2xl lg:rounded-3xl shadow-xl p-4 lg:p-6 border border-purple-100 hover:border-purple-200 transition-all duration-300 hover:-translate-y-1"
          >
...
export default TeacherPremiumAchievements; 