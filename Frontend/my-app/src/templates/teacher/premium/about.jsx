...
const TeacherPremiumAbout = ({ content = component.content, style = component.style }) => (
  <motion.section
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-4">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {content.highlights.map((highlight, idx) => (
              <motion.div
                key={idx}
                className="flex items-center gap-2 bg-white p-3 rounded-xl border border-purple-200 shadow-lg"
        ...
        <div className="flex justify-center items-center">
          ...
          >
            ...
            <img src={content.images[0]} alt="Professional teacher" className="relative w-102 h-102 rounded-3xl object-cover shadow-2xl border-4 border-purple-200" />
          </motion.div>
        </div>
      </div>
    </div>
...
export default TeacherPremiumAbout; 